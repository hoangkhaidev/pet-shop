...
export default function SelectFieldMultipleCurrency({ options, label, required, id, setBrandMultiple, brandMultiple, errorBrandMul, selectDisabled, defaultValue }) {
