...
import { setBorderRadius, setFontFamily } from 'features/customization/customization';
...
const Customization = () => {
    ...
    useEffect(() => {
        ...
        dispatch(setBorderRadius(borderRadiusState));
    }, [borderRadiusState]);
    ...
    // state - font family
    const [fontFamilyState, setFontFamilyState] = useState(initialFont);
    useEffect(() => {
        let newFont;
